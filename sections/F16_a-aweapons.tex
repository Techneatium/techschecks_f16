...
\begin{tcoloritemize}
    ...
    \blueitem{DLZ}{\textbf{D}ynamic \textbf{L}aunch \textbf{Z}one% --- Displays target range \& missile performance information
    \begin{subitemize}
        ...
        \end{itemize}
    \end{subitemize}
    % Displayed on both FCR Page \& HUD once missile selected and radar track acquired
    }
    ...
    \begin{subitemize}
        ...
        \end{itemize}
    \end{subitemize}
    % Displayed on both FCR Page \& HUD once AIM-120 selected and radar track acquired
    }
\end{tcoloritemize}
