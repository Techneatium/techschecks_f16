...
\begin{tcoloritemize}
    ...
    \blueitem{DLZ}{\textbf{D}ynamic \textbf{L}aunch \textbf{Z}one --- Displays target \& missile range information in HUD/FCR page
    \begin{subitemize}
        ...
        \end{itemize}
    \end{subitemize}}
    \blueitem{ASC \& ASEC}{Target lead cues for pilot to maximize missile performance
    \begin{subitemize}
        ...
        \begin{itemize}
            ...
            \item Pilot should place \textbf{ASC} inside \textbf{ASEC}
        \end{itemize}
    \end{subitemize}}
\end{tcoloritemize}
