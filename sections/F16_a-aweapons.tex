...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[c]{0.45\linewidth}
        ...
        \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
            ...
            \node[color2, anchor=west, align=left, font=\small\bfseries] (funnel) at (10,10) {EEGS GUN \\ FUNNEL};
            \node[color2, anchor=west, align=left, font=\small\bfseries] (brst) at (10,32.5) {BORESIGHT \\ CROSS};
            \node[color2, anchor=west, align=left, font=\small\bfseries] (mgrs) at (10,-20) {MGRS \\ LINES};
    ...
    \begin{subfigure}[c]{0.50\linewidth}
        ...
        \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
            ...
            \node[color2, anchor=west, align=left, font=\small\bfseries] (cptreticle) at (20,50) {TARGET \\ DESIGNATOR};
            \node[color2, anchor=west, align=left, font=\small\bfseries] (cpttsymb) at (20,20) {T-SYMBOL};
            \node[color2, anchor=west, align=left, font=\small\bfseries] (cptcombined) at (20,0) {COMBINED \\ PIPPER};

            \draw[->, color2]
            (cptreticle.west) -- ++(-10,0);
            \draw[->, color2]
            (cpttsymb.west) -- ++(-5,0);
            \draw[->, color2]
            (cptcombined.west) -- ++(-5,0);
        \end{tikzpicture}
        \caption{Level V Pipper}
    \end{subfigure}
    % \fbox{
