...
\begin{tcoloritemize}
    ...
    \begin{subitemize}
        \item \textbf{A} --- Launch/Boost
        \item \textbf{B} --- Mid-Course
        \item \textbf{C} --- Acquisition
        \item \textbf{D} --- Intercept
    \end{subitemize}}
    \blueitem{Launch/Boost}{
    \textbf{Boost}
    ...
    \begin{subitemize}
        \item At longer ranges missile ``lofts'' itself to conserve energy \& optimize trajectory
