...
\begin{checklistenumerate}
    ...
    \begin{subenumerate}
        \item Maneuver into firing position
        \item \textbf{DLZ} \dotfill \textbf{Indicates In-Range}
        \item \textbf{Sidewinder Audio} \dotfill \textbf{Lock Tone}
        \item \textbf{WPN REL} \dotfill \textbf{Depress}
    \end{subenumerate}}
\end{checklistenumerate}
...
\begin{checklistenumerate}
    ...
    Recommend RWS mode, \textbf{see \Cref{subsec:rws}}

    \begin{subenumerate}
        \item \textbf{FCR Mode} \dotfill Verify \textbf{CRM-RWS}
    ...
    Launch also possible for TWS Bugged Track, \textbf{see \Cref{subsec:tws}}
    }
    \blueitem{IFF}{%
    \marginpar{
        \captionsetup{type=figure}
    ...
    Prevent blue-on-blue, \textbf{see \underline{SECTION}},
    less critical if \textbf{Link-16} is available

    \begin{subenumerate}
        \item \textbf{TMS} \dotfill \textbf{Left (long)}
        \item Check for IFF returns near target
    \end{subenumerate}
    
    If STT locked, NCTR may be available, \textbf{see \Cref{subsec:stt}}
    }
    \blueitem{Fire Missile}{
    \marginpar{
        \captionsetup{type=figure}
...
\begin{checklistenumerate}
    ...
    \begin{subitemize}
        ...
        \item \textbf{Master Arm} \dotfill \textbf{ARM}
    \end{subitemize}}
    \blueitem{Radar Acquisition}{Demonstrated for TWS mode, \textbf{see \Cref{subsec:tws}}

    \begin{subenumerate}
        \item \textbf{FCR Mode} \dotfill Verify \textbf{CRM-TWS}
    \end{subenumerate}

    Upgrade desired tracks to \textbf{System Tracks}
    ...
    Or upgrade \underline{all} tracks to \textbf{System Tracks}

    \begin{subenumerate}[start=2]
        \item \textbf{TMS} \dotfill \textbf{Right}
    \end{subenumerate}

    Similar 2-target employment possible for RWS-DTT mode, \textbf{see \Cref{subsec:rws}}
    }
    \blueitem{Fire Missiles}{
    \begin{subenumerate}
        \item \textbf{Target} \dotfill under Acquisition cursor
        \item \textbf{TMS} \dotfill \textbf{Forward} (bugged)
        \item \textbf{ASC} \dotfill within \textbf{ASEC}
    ...
    Repeat for all remaining targets

    \medskip
    Bugged target can be cycled in range order with \textbf{TMS Right}}
\end{checklistenumerate}
