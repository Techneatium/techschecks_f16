...
\begin{tcoloritemize}
    ...
    These are illustrated in \cref{fig:aaweap:aim120:profile}.
    }
...
\begin{tcoloritemize}
    \blueitem{Crank}{Fighter turns \textbf{45-60 deg} away from bandit 

    \begin{subitemize}
        \item reduces closure while maintaining radar track
        \item typically used post-launch
    \end{subitemize}}
    \blueitem{Notch}{Fighter turns \textbf{70-110 deg} away from bandit

    \begin{subitemize}
        \item minimizes relative velocity to break hostile pulse-doppler radar track
        \item increases angular motion relative to bandit missile, forcing missile to maneuver and expend energy
    \end{subitemize}}
...
\begin{tcoloritemize}
    ...
    \blueitem{Hot}{Target aspect --- \textbf{0-40 deg}
    \begin{subitemize}
        \item Offensive posture, maximizes closure
    \end{subitemize}}
    \blueitem{Flank}{Target aspect --- \textbf{40-70 deg}
    \begin{subitemize}
        \item Minimizes closure while maintaining radar track
    \end{subitemize}}
    \blueitem{Beam}{Target aspect --- \textbf{70-110 deg}
    \begin{subitemize}
        \item Defensive maneuver to break pulse-doppler radar track
    \end{subitemize}}
    \blueitem{Drag}{Target aspect --- \textbf{110-180 deg}
    \begin{subitemize}
        \item Defensive maneuver to kinematically defeat missile
