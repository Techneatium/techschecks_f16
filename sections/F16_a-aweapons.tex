...
\begin{checklistenumerate}
    ...
    \begin{subitemize}
        ...
        \item \textbf{WARM/COOL} verify \dotfill \textbf{COOL}
        \item \textbf{Master Arm} \dotfill \textbf{ARM}
    \end{subitemize}}
    ...
    \begin{subenumerate}
        \item \textbf{Sidewinder Audio} \dotfill \textbf{Good Tone}
...
\subsubsection{HMCS BORE --- NO RADAR}
...
\begin{checklistenumerate}
    ...
    \begin{subenumerate}
        ...
        \item \textbf{HMD Missile Reticle} \dotfill \textbf{On-Target}
        \item \textbf{CAGE/UNCAGE} \dotfill \textbf{Press}
        \item \textbf{Missile Diamond} \dotfill verify latched to target
        \item Maneuver into firing position
    \end{subenumerate}}
