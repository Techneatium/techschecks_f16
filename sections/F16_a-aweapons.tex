...
\begin{tcoloritemize}
    ...
    \begin{subitemize}
        ...
        \item Employment without radar track (EEGS level II) \\
        \textbf{See \Cref{subsec:m61:eegslvl2}}
        \item Employment with radar track (EEGS level V) \\
        \textbf{See \Cref{subsec:m61:eegslvl5}}
    \end{subitemize}}
    \blueitem{Select GUN}{
...
\begin{tcoloritemize}
    ...
    \begin{subitemize}
        \item \textbf{Maddog} --- \textbf{See \Cref{subsec:aim120:maddog}}
...
\begin{checklistenumerate}
    ...
    \begin{subitemize}
        ...
        \item \textbf{Master Arm} \dotfill \textbf{ARM}
    \end{subitemize}}
    \blueitem{Target Acquisition / IFF}{ 
    \begin{subenumerate}
        \item Maneuver to place target in front of aircraft nose
        \item Verify target area clear of friendly aircraft
    \end{subenumerate}}
    \blueitem{Fire Missile}{
    \begin{subenumerate}
        \item \textbf{WPN REL} \dotfill \textbf{Depress}
