...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \draw[]
        (offset) -- +(25:34) arc (25:-25:34) -- node[pos=0, right, font=\small] {A2} cycle;
        \draw[]
    ...
    % \end{minipage}
    % }
    \caption{FCR azimuth scan \& limits. The varying radii for the different azimuth settings are for illustrative purposes.}
\end{figure}
