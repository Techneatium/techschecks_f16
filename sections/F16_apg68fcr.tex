...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \coordinate (offset) at (-4,0);
        \coordinate (center) at ($(offset)+(0:30)$);

        \draw[]
        (offset) -- node[pos=1, above right, font=\small] {A6} +(60:30) arc (60:-60:30) -- cycle;
        \draw[color2]
        (offset) -- node[pos=1, above right, font=\small] {A3} +(30:30) arc (30:-30:30) -- cycle;
        \draw[red]
        (offset) -- +(25:30) arc (25:-25:30) -- node[pos=0, below right, font=\small] {A2} cycle;
        \draw[]
        (offset) -- node[pos=1, right, font=\small] {A1} +(10:30) arc (10:-10:30) -- cycle;
        \draw[color2, fill=color2!20]
        (offset) -- +(1.5:30) arc (1.5:-1.5:30) -- cycle;

        \node[anchor=west, align=left, font=\small, color2] at (center) {beamwidth} ;
    \end{tikzpicture}
    % \fbox{
