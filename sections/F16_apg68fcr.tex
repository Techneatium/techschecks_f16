...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \node[align=left, font=\bfseries] (stpt) at (5,7) {Current STPT};
        \node[align=left, font=\bfseries] (return) at (0,25) {Radar Returns};
...
\begin{checklistenumerate}
    ...
    \marginpar{
        ...
        \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
            ...
            \node[draw, rounded corners] (cursoroff) at (0,0) {
                \includegraphics[
                    scale=0.25,
                    page={36},
                ]{F16_apg68_RWS_HomePage&SAM_v6-1.pdf}
            };
            \node[draw, rounded corners] (cursoron) at (0,-45) {
                \includegraphics[
                    scale=0.25,
                    page={35},
                ]{F16_apg68_RWS_HomePage&SAM_v6-1.pdf}
            ...
            \draw[->]
            ($(cursoroff.north) + (0,10)$) -- node[pos=0, above, align=center, font=\small] {\textbf{TMS} \textbf{FWD (hold)}}(cursoroff);
            \draw[->]
            (cursoroff) -- node[right, align=center, font=\small] {\textbf{Slew over} \\ \textbf{Target}}(cursoron);
        \end{tikzpicture}
        % \fbox{
...
\begin{checklistenumerate}
    ...
    \marginpar{
        ...
        \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
            ...
            \node[draw, rounded corners, minimum width=\marginparwidth] (track) at (0,-25) {
                \includegraphics[
                    scale=0.25,
                    page={56},
                ]{F16_apg68_RWS_HomePage&SAM_v6-1.pdf}
            };
            \node[draw, rounded corners, minimum width=\marginparwidth] (system) at (0,-60) {
                \includegraphics[
                    scale=0.25,
                    page={44},
                ]{F16_apg68_RWS_HomePage&SAM_v6-1.pdf}
            };
            \node[draw, rounded corners, minimum width=\marginparwidth] (cursor) at (0,-90) {
                \includegraphics[
                    scale=0.25,
                    page={65},
                ]{F16_apg68_RWS_HomePage&SAM_v6-1.pdf}
            };
            \node[draw, rounded corners, minimum width=\marginparwidth] (bugged) at (0,-115) {
                \includegraphics[
                    scale=0.25,
                    page={66},
                ]{F16_apg68_RWS_HomePage&SAM_v6-1.pdf}
            ...
            \draw[->]
            ($(track.south)!0.5!(system.north) + (-10,0)$) arc (180:360:5) arc (0:180:5);
        \end{tikzpicture}
        % \fbox{
        %     \begin{minipage}[t][60mm][t]{\marginparwidth}
