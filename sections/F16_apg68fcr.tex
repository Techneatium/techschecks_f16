    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \node[] (mfd) at (0,0) {
            \includegraphics[
                height=100mm,
                page={69},
            ]{F16_apg68_RWS_HomePage&SAM_v7.pdf}
        };

        \node[align = center] at (0,-20) {\color{red}\textbf{MISSING ANNOTATIONS} \\ \color{red}\textbf{AZ LINES NEED REMOVAL}};
    \end{tikzpicture}
    % \fbox{
    % \begin{minipage}[t][75mm][t]{100mm}
...
\begin{figure}[htbp]
    ...
    % }
    \caption{
        ACM Scan Patterns shown with the relative HUD symbology. 
        The dashed lines illustrate the scan volume for illustrative purposes and are not exact.
    }
\end{figure}
