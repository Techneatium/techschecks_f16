...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \draw[]
        (offset) -- node[pos=1, above, font=\small] {+/- 60} +(60:35) arc (60:-60:35) -- cycle;
        \draw[color2, fill=color2!20]
        ...
        \coordinate (4boffset) at ($(4bar) + (10,0)$);
        \coordinate (3boffset) at ($(3bar) + (10,0)$);
        \coordinate (2boffset) at ($(2bar) + (10,0)$);
        \coordinate (1boffset) at ($(1bar) + (10,0)$);

        % 4bar
        \draw[->, rounded corners, ultra thick,]
        (4boffset)
        -- ($(4boffset) + (0,3.75)$) -- ($(4boffset) + (40,3.75)$) -- ++(0,-2.5)
        -- ++(-39,0) -- ++(0, -2.5)
        ...
        \draw[->, rounded corners, ultra thick,]
        (3boffset)
        -- ($(3boffset) + (0,2.5)$) -- ($(3boffset) + (40,2.5)$) -- ++(0,-2.5)
        -- ++(-40,0) -- ++(0, -2.5)
        ...
        % 2bar
        \draw[->, rounded corners, ultra thick,]
        ($(2boffset) + (0,1.25)$) -- ($(2boffset) + (40,1.25)$)
        -- ($(2boffset) + (40,-1.25)$) -- ($(2boffset) + (0,-1.25)$)
        -- cycle;

        % 1bar
        \draw[->, rounded corners, ultra thick,]
        ($(1boffset) + (0,0)$) -- ($(1boffset) + (40,0)$) 
        -- cycle;
    \end{tikzpicture}
    % \fbox{
    % \begin{minipage}[t][75mm][t]{100mm}
