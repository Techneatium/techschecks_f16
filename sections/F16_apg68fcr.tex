...
\begin{tcoloritemize}
    ...
    \begin{subitemize}
        \item \textbf{Once trackfile generated}
        \item \textbf{Can be transitioned to higher fidelity modes by pilot}
        \item \textbf{Display}
        \begin{itemize}
    ...
    \begin{subitemize}
        \item \textbf{Allows pilot to select targets of interest}
        \begin{itemize}
            \item To monitor
            \item Or for future weapons employment
        \end{itemize}
...
\begin{checklistenumerate}
    ...
    FCR automatically upgrades Search Targets to Track Targets once sufficient information available
    }
    ...
    \begin{subenumerate}
        \item \textbf{TMS} \dotfill \textbf{Right}
    \end{subenumerate}
    Further depresses cycle through all System Targets in range order
    }
