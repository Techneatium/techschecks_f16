...
\begin{tcoloritemize}
    ...
    \begin{subitemize}
        \item \textbf{Scan}
        \begin{itemize}
            \item Interrogates entire radar scan volume
            \item Activated by pressing \textbf{TMS Left (short)}
            \item \textbf{SCAN} appears next to \textbf{OSB 16} on FCR page
        \end{itemize}
        \item \textbf{LOS} --- \textbf{L}ine \textbf{O}f \textbf{S}ight
        \begin{itemize}
            \item Interrogates locked target or scan volume around acquisition cursor
