...
\begin{checklistenumerate}
    ...
    %         \coordinate (base) at (-15,-10);
    %         \coordinate (final) at (-7.5,-17.5);
    %         \coordinate (shortfinal) at (0,-10);
    %         \coordinate (touchdown) at (0,0);
    %         \coordinate (rollout) at (0,10);

    %         % runway
    %         \draw[thick]
    %         ($(touchdown)+(-2,-5)$) -- ($(touchdown)+(2,-5)$) -- 
    %         ($(touchdown)+(2,20)$) -- ($(touchdown)+(-2,20)$) -- 
    %         cycle;
    %         \draw[thick]
    ...
    %         % nodes
    %         \node[right, align=left, anchor=south west] at (approach) {\textbf{1.}};
    %         \node[right] at (break) {\textbf{2.}};
    %         \node[left, align=right, anchor=north east] at (downwind) {\textbf{3.}};
    %         \node[left] at (base) {\textbf{4.}};
    %         \node[below] at (final) {\textbf{5.}};
    %         \node[left] at (shortfinal) {\textbf{6.}};
    %         \node[above] at (rollout) {\textbf{7.}};
    ...
    \marginpar{
        ...
        \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
            ...
            % coordinates
            \coordinate (approach) at (5,-15);
            \coordinate (break) at (5,0);
            \coordinate (downwind) at (-15,0);
