...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \caption*{\textbf{2. ENG Instruments}}
    \end{subfigure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \caption*{\textbf{2./3. Avionics \& INS}}
    \end{subfigure}
...
\begin{tcolorenumerate}[resume]
    \blueitem{SNSR PWR Panel}{\cbstart
    \begin{subenumerate}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \caption*{\textbf{3. FUEL QTY Check}}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\linewidth}
        \centering
        \includegraphics[
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \includegraphics[
            width = \cockpitfigwidth,
        ]{F16_proc_start-up_check-epu_v01.pdf}
