...
%-----------------------------------------------------------------
    ...
    \begin{tcolorbox}[
		...
		boxed title style={
			sharp corners,
		}, title=\Large\textbf{BEFORE TAKEOFF READ THIS}
	]
    \cbstart
    \textbf{Obligatory Steps} -- Procedural steps marked by solid bars long the page edge can not be skipped without impacting mission capability signficantly.
    ...
    \notebox{
        Information to be emphasized, usually related but not necessary information regarding a system or procedure.
    }

    \warningbox{
        Additional information which much be adhered to for proper system operation without malfunction or damage.
    }
