...
\paragraph{A-A Modes}
\begin{itemize}
    \item \textbf{CRM} --- \textbf{C}ombined \textbf{R}adar \textbf{M}ode, see \Cref{subsec:crm}
    \begin{itemize}
        \item \textbf{RWS} --- \textbf{R}ange \textbf{W}hile \textbf{S}earch, see \Cref{subsec:rws}
        \item \textbf{TWS} --- \textbf{T}rack \textbf{W}hile \textbf{S}can, see \Cref{subsec:tws}
    \end{itemize}
