...
\begin{tcoloritemize}
    ...
    \textbf{Disadvantage}
    \begin{itemize}
        \item wingmen must constantly reference lead
    \end{itemize}
...
\begin{tcoloritemize}
    ...
    Reference \cref{fig:supp_fig:form:4shiplab} for illustration
    \blueitem[Spread] 
    \textbf{Relaxed line abreast} --- more room for wingman to maneuver, easier to maintain

    Reference \cref{fig:supp_fig:form:spread} for illustration
    
    \blueitem[Fluid Four]
    \textbf{Relaxed line abreast} --- wingmen in fighting wing
    
    Reference \cref{fig:supp_fig:form:fluidfour} for illustration
\end{tcoloritemize}
