...
\begin{tcoloritemize}
    ...
    \textbf{Tactical Formation} --- allows simultaneous weapons employment,
    reference \cref{fig:supp_fig:form:4shiplab}
    ...
    \end{itemize}
    \blueitem[Spread] 
    \textbf{Relaxed line abreast} --- more room for wingman to maneuver, easier to maintain,
    reference \cref{fig:supp_fig:form:spread}
    
    \blueitem[Fluid Four]
    \textbf{Relaxed line abreast} --- wingmen in fighting wing,
    reference \cref{fig:supp_fig:form:fluidfour}
\end{tcoloritemize}
...
\begin{tcoloritemize}
    \blueitem[Res Cell] 
    \textbf{Encumbers bandit radar sort} --- wingmen hide within resolution cell of bandit radar,
    reference \cref{fig:supp_fig:form:rescell}

    \blueitem[Box] 
    \textbf{Staggered line abreast} --- allows trailing element to cover lead element, trail can offset 
    reference \cref{fig:supp_fig:form:boxoffset}
    
    \blueitem[Diamond]
    \textbf{Airshow formation} --- no tactical advantage, hard to maintain, you will die looking cool,
    reference \cref{fig:supp_fig:form:diamond}
\end{tcoloritemize}
...
\begin{tcoloritemize}
    ...
    distance as briefed,
    reference \ref{fig:supp_fig:form:trail}

    \blueitem[Stack]
    \textbf{More restrictive trail} --- similar to trail but with altitude separation and tighter distance constraints,
    reference \ref{fig:supp_fig:form:stack}

    \blueitem[Ladder]
    \textbf{A-G formation} --- similar to trail with altitude separation,
    reference \ref{fig:supp_fig:form:ladder}
\end{tcoloritemize}
