...
\cautionbox{
    \small 
    Wingman is responsible for deconfliction during maneuvers. 
    Do \textbf{NOT} hit lead! 
    Even in the event that the wingman survives, they are still in considerable danger, especially if lead survived!
}

\paragraph{Tactical Turn}
...
\paragraph{Overhead \break Approach}
