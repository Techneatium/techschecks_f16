...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[figstyle]
        ...
        % fighter wez
        \draw[fill=color2!15] 
        (flight_lead) -- ++(60:30) arc (60:120:30) -- cycle
        (lead_wing) -- ++(60:30) arc (60:120:30) -- cycle
        (elem_lead) -- ++(60:30) arc (60:120:30) -- cycle
        (elem_wing) -- ++(60:30) arc (60:120:30) -- cycle;

        % fighters
        \node[] (flight_lead_fig) at (flight_lead) {
            \includegraphics[
                width=7.5mm,
            ]{diagrams/aircraft/silhouette_f16_top.pdf}
        };
        \node[] (lead_wing_fig) at (lead_wing) {
            \includegraphics[
                width=7.5mm,
            ]{diagrams/aircraft/silhouette_f16_top.pdf}
        };
        \node[] (elem_lead_fig) at (elem_lead) {
            \includegraphics[
                width=7.5mm,
            ]{diagrams/aircraft/silhouette_f16_top.pdf}
        };
        \node[] (elem_wing_fig) at (elem_wing) {
            \includegraphics[
                width=7.5mm,
            ]{diagrams/aircraft/silhouette_f16_top.pdf}
        };
