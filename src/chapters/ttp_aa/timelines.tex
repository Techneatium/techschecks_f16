...
\begin{checklistenumerate}[start=0]
    ...
    \marginpar{
        ...
        \begin{tikzpicture}[figstyle]
            ...
            \node[font=\footnotesize,anchor=west] at (25,65) {WEZ};
            \node[font=\footnotesize,anchor=west] at (25,55) {MAR};
            \node[font=\footnotesize,anchor=west] at (25,40) {DOR};
            \node[font=\footnotesize,anchor=west] at (25,20) {MRR};
            \node[font=\footnotesize,anchor=west] at (25,30) {TR};
            \node[font=\footnotesize,anchor=west] at (25,10) {MTR};
            \node[font=\footnotesize,anchor=west] at (25,5) {CR};
            ...
            \node[left, align=right, font=\small] at (recommit) {
