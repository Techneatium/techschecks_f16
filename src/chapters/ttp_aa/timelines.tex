...
\notebox{
    \small\textbf{\Crefrange{fig:ttpaa:timeline:banzai}{fig:ttpaa:timeline:skate} are not to scale, any crank maneuvers are ommitted for compactness.}
}
