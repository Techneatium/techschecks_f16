...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \draw[annotptr] (mode.east) -- ++(10mm, 0mm) -- (-25mm,29mm);

        \node[lannot] (submode) at ($(fig.west)+(0mm,14mm)$) {Submode};
        \draw[annotptr] (submode.east) -- ++(22.5mm, 0mm) -- (-11mm, 29mm);

        \node[rannot] (inv) at ($(fig.east)+(0mm,27mm)$) {Inventory};
        \draw[annotptr] (inv.west) -- ++(-21mm, 0mm) -- (14mm, 29mm);

        \node[rannot] (rounds) at ($(fig.east)+(0mm,14mm)$) {Rounds \\ remaining};
        \draw[annotptr] (rounds.west) -- ++(-8mm,0mm) -- (28mm, 18mm);

        \node[rannot] (rdy) at ($(fig.east)+(0mm,0mm)$) {Ready \\ indication};
        \draw[annotptr] (rdy.west) -- ++(-20mm, 0mm) -- (10mm,18mm);

        \node[rannot] (sj) at ($(fig.east)+(0mm,-14mm)$) {Selective Jettison};
        \draw[annotptr] (sj.west) -- ++(-12.5mm, 0mm) -- ($(fig.south) + (22mm,12mm)$);
    \end{tikzpicture}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \draw[annotptr] (bandit.west) -- ++(-37mm, 0mm) -- (1mm,20mm);
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \begin{tikzpicture}[figstyle]
            ...
            \draw[annotptr] (1g.east) -- ++(22mm,0mm) -- (-1.5mm,5mm);
            ...
            \draw[annotptr] (manpot.west) -- ++(-10mm, 0mm) -- (12mm,2mm);
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \begin{tikzpicture}[figstyle]
            ...
            \draw[annotptr] (bandit.west) -- ++(-23mm,0mm) -- (2.5mm, -3mm);
        \end{tikzpicture}
