...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        arc  (0:-20:60) 
        node[font=\footnotesize, right, pos=0.5] {12000'}
        node[font=\footnotesize, pos=1, below right] {20$^\circ$}
        -- ++(160:40)
        arc (-20:0:20)
        node[font=\footnotesize, right, pos=0.5] {4000'};
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \draw[dashed]
        (1) -- ++(-150:10) arc (-150:-120:10) -- (1);

        \draw[fill=color2!15]
        ($(1)+(-150:10)$) 
        -- ++(-150:20)
        arc  (-150:-120:30) 
        node[font=\footnotesize, pos=0.5, below left] {fighting wing}
        -- ++(60:20)
        arc (-120:-150:10);

        \draw[dashed]
        (3) -- ++(-30:10) arc (-30:-60:10) -- (3);

        \draw[fill=color2!15]
        ($(3)+(-30:10)$) 
        -- ++(-30:20)
        arc  (-30:-60:30) 
        node[font=\footnotesize, pos=0.5, below right] {fighting wing}
        -- ++(120:20)
        arc (-60:-30:10);
