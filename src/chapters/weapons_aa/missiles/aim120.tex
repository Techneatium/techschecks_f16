...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \draw[annotptr] (mode.east) -- ++(15mm, 0mm) -- (-24mm,32mm);
        ...
        \draw[annotptr] (inv.west) -- ++(-26mm, 0mm) -- (13mm, 32mm);
        ...
        \draw[annotptr] (sj.west) -- ++(-15mm, 0mm) -- ($(fig.south) + (25mm,2mm)$);
    \end{tikzpicture}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \draw[annotptr] (asec.east) -- ++(8mm,0mm) -- (-16mm,16mm);

        \node[lannot] (asc) at ($(fig.west)+(-2.5mm,-10mm)$) {ASC};
        \draw[annotptr] (asc.east) -- ++(20mm,0mm) -- (0mm, -3mm);

        \node[rannot] (aspect) at ($(fig.east)+(2.5mm,10mm)$) {Aspect caret};
        \draw[annotptr] (aspect.west) -- ++(-18mm, 0mm) -- (1mm,20mm);
    \end{tikzpicture}
    \caption{
