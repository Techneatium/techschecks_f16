    ...
    \begin{tikzpicture}[auto, node distance=10mm, x=1mm, y=1mm, very thick, line cap=round,
        ...
        \node[] (fig) at (0,0) {
            \includegraphics[
                height=75mm,
                page={7},
            ]{weap_aa_missilelaunch_new_v2.pdf}
        };
...
\begin{checklistenumerate}
    ...
    \marginpar{
        ...
        \begin{tikzpicture}[figstyle]
            ...
            \node[
                boxedmarfigstyle,                below=12.5 of system,
            ] (cursor) {
                \includegraphics[
                    scale=0.5,
                    page={32},
            ...
            \node[
                boxedmarfigstyle,                below=10 of cursor,
            ] (bugged) {
                \includegraphics[
                    scale=0.5,
                    page={33},
            ...
            \node[
                boxedmarfigstyle,                below=10 of bugged,
            ] (dlz) {
                \includegraphics[
                    scale=0.5,
                    page={16},
            ...
            \node[
                boxedmarfigstyle,                below=10 of dlz,
            ] (post) {
                \includegraphics[
                    scale=0.5,
                    page={34},
