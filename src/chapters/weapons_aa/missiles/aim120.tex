...
\paragraph{Employment Types}
\begin{itemize}
    \item \textbf{Maddog / Active Launch  (no radar)}
    \hfill\hyperref[subsec:aim120:maddog]{see \Cref{subsec:aim120:maddog}}
    \item \textbf{Single-target employment (STT lock or TWS/DTT bug)}\\
    \hfill\hyperref[subsec:aim120:single]{see \Cref{subsec:aim120:single}}
    \item \textbf{Multi-target employment (TWS/DTT bug)}
    \hfill\hyperref[subsec:aim120:multi]{see \Cref{subsec:aim120:multi}}
\end{itemize}

\paragraph{Flight Profile}
...
\textbf{See \Cref{sec:ttp_aa:bvr_fundamentals,sec:ttp_aa:bvr_fundamentals:rangeconsideration} for further details on AIM-120 flight profile and range considerations}

\clearpage

\paragraph{Select AIM-120}
Via A-A Master Mode
\begin{enumerate}
...
\paragraph{Basic Radar Symbology} 
For beyond-visual-range radar usage and symbology 
\textbf{reference \Crefrange{subsec:crm}{subsec:tws}}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item not shown in \cref{fig:aa_weap:aim120:dlz}
    \end{itemize}
...
\paragraph{Missile Diamond} 
Indicates missile seeker line-of-sight

\paragraph{Post-Launch Symbology}
